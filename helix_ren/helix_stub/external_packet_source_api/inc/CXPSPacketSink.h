/* ***** BEGIN LICENSE BLOCK *****
 *
 * Version: $Id: CXPSPacketSink.h,v 1.7 2009/07/15 17:48:27 alvarovaquero Exp $
 * 
 * Copyright Notices: 
 *  
...
public:
    ...
    //          XpsStreamPushdownValue: Defines the minimum audio pushdown value used
    //                          to calculate Helix preroll. If not available default value will be used.
    //
    //
    // Note: 
